...
export default function Footer() {
  ...
  return (
    <footer ref={ref} id="contact" className="relative overflow-hidden px-6 pt-28 md:pt-40">
      <div className="pointer-events-none absolute -bottom-40 left-1/2 h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,208,0,0.12),transparent_60%)] blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div style={{ y }} className="relative text-center">
          ...
          <a href="mailto:hello@hivenex.studio" className="group inline-block">
            <h2 className="font-display text-[13vw] font-semibold leading-[0.9] tracking-[-0.03em] transition-colors md:text-[9vw]">
              <span className="block transition-transform duration-500 group-hover:-translate-y-1">
                Let's make
              </span>
              <span className="block text-accent transition-transform duration-500 group-hover:translate-y-1">
                something great.
              </span>
            </h2>
          </a>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="mt-12 inline-flex items-center gap-3 rounded-full bg-white px-8 py-4 font-medium text-black"
          >
